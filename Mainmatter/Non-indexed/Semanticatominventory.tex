...
$^1${\normalsize \noindent Not all syllables were used, since we have 490 options in total, there are 42 additional words which weren't used and can be used when additional words are added when expanding the language.}
