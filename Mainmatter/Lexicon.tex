...
\thead{\bf Frequency in the \\ \bf 100 most spoken \\ \bf languages}& 
	

\thead{\bf Frequency in the \\ \bf $\alpha$ set} & 
	

\thead{ \bf Percentage in the \\ \bf $\alpha$ set }& 
	

\thead{\bf Error in the \\ \bf $\alpha$ set} & 
	

\thead{\bf Frequency in the \\ \bf $\beta$ set} & 
	

\thead{\bf Percentage in the \\ \bf $\beta$ set}& 
	

\thead{\bf Error in the \\ \bf  $\beta$ set}\\ 
