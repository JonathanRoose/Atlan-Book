...
\small
\begin{center}
{\Large 7. NSM\idx{Natural Semantic Metalanguage} Modules}
\begin{tabular}{|l|l|}
	\hline
\textbf{Category}& 
\textbf{Primes}\\ 
...
{\Large 8. Culture-specific NSM\idx{Natural Semantic Metalanguage} Modules}
...
\begin{center}
{\Large 9. Proposed universal NSM\idx{Natural Semantic Metalanguage}-modules}
%\begin{tabular}{|l|l|}
\begin{tabular}{|p{0.162\pagewidth}|p{0.615\pagewidth}|}
\hline
\textbf{Category}& 
