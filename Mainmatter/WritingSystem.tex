...
Then, our numeral glyphs rely on Lua\LaTeX\, a more potent version of \TeX. The command, again, is straightforward. You simply state \texttt{\\numbr\{<number>\footnotemark\}}. \footnotetext{Due to the nature of our numeric system, the biggest number you can fill in decimals, is 9999.}  An example of the command: \texttt{\symbol{92}numbr\{321\}} produces \numbr{321}. To produce a duodecimal number, you type \verba|\numbrdd{1435}| to get \numbrdd{1435}\footnote{The highest duodecimal number you can fill in, is 20735.}. 
